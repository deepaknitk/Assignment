...
// function to fetch list of king in sorted order based on given point. +2 -- Win , -1 --Loss
exports.listOfKing = function(req,callback){
	//console.log("sdfd");
	var queryString =  "select attacker_king, sum(win) as total_point from ((select attacker_king, count(attacker_outcome)*2 as win from battles "
